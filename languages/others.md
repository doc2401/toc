...
> 涵盖函数式编程、数据科学、新兴系统语言以及各端主力语言。

### 📱 移动端与跨端
- **[Kotlin 官方中文文档](https://kotlinlang.org/docs/home.html)** — 现代 JVM 语言与 Android 首选开发语言
...
- **[Groovy 官方文档](https://groovy-lang.org/documentation.html)** — JVM 脚本语言
...
- **[Phoenix](https://hexdocs.pm/phoenix/)** — Elixir 全栈 Web 框架，实时能力强 `官方在线`
