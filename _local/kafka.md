...
> 提供 Apache Kafka 消息队列的本地历史版本镜像与官方在线文档。

### 🌐 官方在线文档 (Online Official Docs)
- **[Apache Kafka 官方网站](https://kafka.apache.org/)** — Kafka 开源项目首页
- **[Apache Kafka 官方技术文档](https://kafka.apache.org/documentation/)** — 核心配置、设计原理及 API 参考
