...
+   [Spring Data for Apache Couchbase](https://spring.io/projects/spring-data-couchbase)   
    Easy configuration and access to Apache Couchbase or large scale, highly available, data oriented Spring applications.    
...
+   [Spring Data for Elasticsearch](https://spring.io/projects/spring-data-elasticsearch)   
    Easy configuration and access to Elasticsearch or large scale, highly available, data oriented Spring applications.    
...
+   [Spring Data Neo4j](https://spring.io/projects/spring-data-neo4j)   
    Easy configuration and access to Neo4j or large scale, highly available, data oriented Spring applications.    
