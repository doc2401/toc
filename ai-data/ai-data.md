...
> 汇总机器学习、生成式 AI、模型应用、数据处理、流计算与分析平台文档。
...
### Python 数据与机器学习
- **[NumPy](https://numpy.org/doc/stable/)** — 数值计算基础库 `官方在线`
- **[pandas](https://pandas.pydata.org/docs/)** — 表格数据分析库 `官方在线`
- **[Jupyter](https://docs.jupyter.org/)** — 交互式计算与 Notebook `官方在线`
...
- **[Apache Flink](https://flink.apache.org/what-is-flink/flink-architecture/)** — 有状态流处理平台 `官方在线`
