...
> 汇集常用的官方在线文档与本地离线镜像，为您提供快速、稳定、高效的参考导航服务。

## ☕ Java 生态

- [Java 教程](/java/java.md) `本地 & 在线`
- [JDK 核心文档](/java/jdk.md) `本地 & 在线`
...
- [Python 3 🌐](https://docs.python.org/zh-cn/3/) `官方在线`
...
- [MDN Web Docs 🌐](https://developer.mozilla.org/zh-CN/) `官方在线`
- [Vue.js 🌐](https://cn.vuejs.org/) `官方在线`
- [React 🌐](https://zh-hans.react.dev/) `官方在线`
- [Angular 🌐](https://angular.dev/) `官方在线`
- [Svelte 🌐](https://svelte.dev/docs) `官方在线`
- [Astro 🌐](https://docs.astro.build/zh-cn/) `官方在线`
- [Vite 构建工具 🌐](https://cn.vitejs.dev/) `官方在线`
- [查看更多前端...](/frontend/frontend.md) `参考分类`

## 🧱 后端框架与运行时

- [后端框架完整索引](/backend/frameworks.md) `参考分类`
- [FastAPI 🌐](https://fastapi.tiangolo.com/zh/) `官方在线`
- [Django 🌐](https://docs.djangoproject.com/zh-hans/) `官方在线`
- [NestJS 🌐](https://docs.nestjs.com/) `官方在线`
- [ASP.NET Core 🌐](https://learn.microsoft.com/zh-cn/aspnet/core/) `官方在线`
- [Gin 🌐](https://gin-gonic.com/docs/) `官方在线`
- [Laravel 🌐](https://laravel.com/docs) `官方在线`
...
- [OpenSearch 🌐](https://docs.opensearch.org/latest/) `官方在线`
...
- [API 与安全索引](/api-security/api-security.md) `参考分类`
- [OpenAPI / Swagger](/api-security/api-security.md) `官方在线`
- [GraphQL / gRPC](/api-security/api-security.md) `官方在线`
- [OAuth / OpenID Connect / Keycloak](/api-security/api-security.md) `官方在线`
...
- [Docker & K8s 集群](/devops/devops.md) `官方在线`
- [Git / Nginx / Linux](/devops/devops.md) `官方在线`
- [Eclipse IDE 帮助中心](/devops/eclipse.md) `本地镜像`
...
- [Blender 3D 建模](/graphics/blender.md) `本地 & 在线`
...
>
> **路径说明：** 索引中的文档链接使用 `../<repository>/` 相对路径。只要 `toc` 与各文档目录保持平级，同一份索引即可无缝使用。
