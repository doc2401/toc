...
- **[Kubernetes 官方中文文档](https://kubernetes.io/zh-cn/docs/)** — K8s 集群管理、Pod/Service 部署与核心概念中文手册
- **[Podman 官方文档](https://docs.podman.io/)** — 无守护进程容器与 Pod 管理工具
- **[Helm 中文文档](https://helm.sh/zh/docs/)** — Kubernetes 包管理器

### 🌐 Web 服务器 (Web Server)
- **[Nginx 官方开发手册](https://nginx.org/en/docs/)** — Nginx 配置文件说明、反向代理、负载均衡与指令参考

### 🛠️ 构建工具与包管理器 (Build Systems)
- **[Apache Maven 核心参考](https://maven.apache.org/guides/index.html)** — Maven 生命周期、pom.xml 配置与常用插件指南
- **[Gradle 官方使用指南](https://docs.gradle.org/current/userguide/userguide.html)** — Gradle 构建脚本、多项目构建与核心 API 手册
- **[npm 官方文档](https://docs.npmjs.com/)** — Node.js 包管理器
- **[pnpm 中文文档](https://pnpm.io/zh/)** — 高效、节省磁盘空间的包管理器
...
- **[GitLab CI/CD](https://docs.gitlab.com/ci/)** — GitLab 持续集成与部署
- **[Argo CD](https://argo-cd.readthedocs.io/)** — Kubernetes GitOps 持续交付
...
- **[Grafana 官方文档](https://grafana.com/docs/)** — 强大的多源指标分析展现与数据可视化平台手册
- **[OpenTelemetry 中文文档](https://opentelemetry.io/zh/docs/)** — 指标、日志与分布式追踪标准
- **[Grafana Loki](https://grafana.com/docs/loki/latest/)** — 日志聚合系统
- **[Jaeger](https://www.jaegertracing.io/docs/)** — 分布式链路追踪平台

### 💻 版本控制与系统命令 (Version Control & OS)
- **[Git Pro 官方中文教程](https://git-scm.com/book/zh/v2)** — 权威的 Git 版本控制系统原理及命令使用指南
...
- **[Visual Studio](https://learn.microsoft.com/zh-cn/visualstudio/)** — Visual Studio IDE 文档
